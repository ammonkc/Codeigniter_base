...
class Authorize_net {
	...
	function Authorize_net() {
		...
		$this->add_x_field('x_version', $this->CI->config->item('authorize_net_x_version'));
      	...
      	$this->add_x_field('x_currency_code', $this->CI->config->item('authorize_net_x_currency_code'));
      	$this->add_x_field('x_duplicate_window', $this->CI->config->item('authorize_net_x_duplicate_window'));
	}
