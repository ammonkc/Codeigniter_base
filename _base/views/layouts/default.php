...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head>        
        ...
        <?php
            ...
            //echo '<!--[if lt IE 7]><script type="text/javascript" src="'.base_url().'assets/javascript/jquery/plugins/supersleight.plugin.js"></script><![endif]-->';
            echo '<!--[if lt IE 7]><script src="'.base_url().'assets/javascript/ie/DD_belatedPNG_0.0.8a-min.js" type="text/javascript"></script><![endif]-->';
            //echo '<!--[if lte IE 7]><script type="text/javascript" src="'.base_url().'assets/javascript/ie/DD_roundies_0.0.2a-min.js"></script><![endif]-->';
