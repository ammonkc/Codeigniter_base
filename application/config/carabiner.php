...
$config['groups']['main'] = array(
                                'js'  => array(
                                              ...
                                              array('jquery-1.5.js', 'jquery-1.5.min.js', TRUE, FALSE),
                                              array('global.js')
                                              ),
                                'css' => array(
                                              array('reset.css', 'all'),
...
$config['groups']['jquery-plugins'] = array(
                                           'js'  => array(
                                                         array('jquery/jquery-ui-1.8.7.min.js', 'jquery/jquery-ui-1.8.7.min.js', TRUE, FALSE),
                                                         array('jquery/jquery.iphoneSwitch.js', 'jquery/jquery.iphoneSwitch.js', TRUE, FALSE),
                                                         array('jquery/jquery.customSelect.js', 'jquery/jquery.customSelect.js', TRUE, FALSE)
                                                         ),
                                           'css' => array(
                                                         array('jquery/ui-aristo/jquery-ui-1.8.7.custom.css'),
                                                         array('jquery/ui-slider/jquery-ui-1.8.7.custom.slider.css')
                                                         )
                                           );
// IE6
...
/* Location: ./system/application/config/carabiner.php */